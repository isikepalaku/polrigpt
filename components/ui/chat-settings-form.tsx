    ...
    <div className="space-y-3">
      ...
      <div className="space-y-1">
        ...
        <TextareaAutosize
          ...
          placeholder="Kamu adalah asisten penyidik polri."
  ...
  return (
    <div className="mt-5">
      ...
      <div className="mt-7 flex items-center space-x-2">
        ...
        <Label>Chat Termasuk Konteks Profil</Label>
          ...
          <WithTooltip
            ...
            display={
              <div className="w-[400px] p-3">
                {profile?.profile_context || "Tidak ada konteks profil."}
              </div>
            }
            trigger={
      ...
      <div className="mt-4 flex items-center space-x-2">
        ...
        <Label>Chat Termasuk Instruksi Workspace</Label>
      ...
      <div className="mt-5">
        <Label>Penyedia Embeddings</Label>
