...
export const CHAT_SETTING_LIMITS: Record<LLMID, ChatSettingLimits> = {
  ...
  "gpt-4o-mini": {
    MIN_TEMPERATURE: 0.0,
    MAX_TEMPERATURE: 2.0, // Asumsikan sama dengan model GPT-4 lainnya
    MAX_TOKEN_OUTPUT_LENGTH: 16384, // Sesuai dengan "Max output tokens" dalam dokumentasi
    MAX_CONTEXT_LENGTH: 128000 // Sesuai dengan "Context window" dalam dokumentasi
  },
  "ft:gpt-4o-mini-2024-07-18:personal::AJdyClpB": {
    MIN_TEMPERATURE: 0.0,
    MAX_TEMPERATURE: 2.0,
